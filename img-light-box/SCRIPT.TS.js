        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error = _a.sent();
                    console.log(error);
                    return [2 /*return*/]; // Stop execution
...
function SHOW_IMAGES(IMAGES) {
    ...
    IMAGES.forEach(function (IMG) {
        ...
        IMAGESEC.src = IMG.download_url; // Use correct property
        IMAGESEC.alt = IMG.author;
        IMAGESEC.onclick = function (E) {
            console.log(E.target.src);
        };
        IMAGE_CONTAINER.appendChild(IMAGESEC);
    });
}
